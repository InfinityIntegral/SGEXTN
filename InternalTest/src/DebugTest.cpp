...
namespace {
SGEXTN::SingText::String lastSentString;

void logIntoString(const char* s){
    const SGEXTN::SingText::String msg = s;
    lastSentString = msg.substringCharactersRight(msg.characterLength() - msg.findFirstCharactersFromLeft(" : ") - 3);
}
}

template class SGEXTN::KaypohOne::StealStaticVariable<0, SGEXTN::SingText::Debug, SGEXTN::Containers::Vector<void (*)(const char*)>*, &SGEXTN::SingText::Debug::logFunctionList>;

void SGEXTN::InternalTest::DebugTest::runTest(){
    void (*originalFunction)(const char*) = nullptr;
    SGEXTN::Containers::Vector<void (*)(const char*)>* functionList = SGEXTN::KaypohOne::StaticVariable<0, SGEXTN::SingText::Debug, SGEXTN::Containers::Vector<void (*)(const char*)>*>::beKaypoh();
    ...
    SG(SGEXTN::SingText::DebugPrintCCharMode::Character)('a');
    ...
    SG(SGEXTN::SingText::DebugPrintIntegerMode(16))(26);
    if(lastSentString != "1a"){SGEXTN_IMMEDIATE_CRASH("SGEXTN::CoreTest::Debug log int custom formatting fail");}
    SG(SGEXTN::SingText::DebugPrintFloatingPointMode(2, SGEXTN::SingText::FloatPrecisionFormat::ScientificNotation, 5))(0.25f);
    if(lastSentString != "1.0000^-10"){SGEXTN_IMMEDIATE_CRASH("SGEXTN::CoreTest::Debug log float custom formatting fail");}
    SG(SGEXTN::SingText::Character());
    if(lastSentString != SGEXTN::SingText::Character()){SGEXTN_IMMEDIATE_CRASH("SGEXTN::CoreTest::Debug log character fail");}
    const SGEXTN::SingText::String stringToLog = "abc";
    SG(stringToLog);
    if(lastSentString != "abc"){SGEXTN_IMMEDIATE_CRASH("SGEXTN::CoreTest::Debug log string fail");}
    SG(SGEXTN::SingText::DebugPrintStringMode::Byte)(stringToLog);
    if(lastSentString != "61 62 63"){SGEXTN_IMMEDIATE_CRASH("SGEXTN::CoreTest::Debug log string as bytes fail");}
    SG(SGEXTN::SingText::DebugPrintStringMode::CodePoint)(stringToLog);
    ...
    SG(1)(2)(3)(SGEXTN::SingText::DebugPrintIntegerMode(2))(4)(5);
    ...
    SGEXTN::SingText::String (SGEXTN::InternalTest::DebugTest::*const testFunction3)() const = nullptr;
    ...
    SG(SGEXTN::SingText::DebugPrintPointerMode::TryDeref)(intPointer);
    ...
    SG(SGEXTN::SingText::DebugPrintPointerMode::TryDeref)(constIntPointer);
    ...
    SG(SGEXTN::SingText::FloatPrecisionFormat::SignificantFigure);
    ...
    {
        const SGEXTN::SingText::DebugDefaultModeOverride changeDefaults(SGEXTN::SingText::DebugPrintIntegerMode(3), SGEXTN::SingText::DebugPrintFloatingPointMode(10, SGEXTN::SingText::FloatPrecisionFormat::FractionalDigit, 2), SGEXTN::SingText::DebugPrintCCharMode::Character, SGEXTN::SingText::DebugPrintStringMode::Byte, SGEXTN::SingText::DebugPrintPointerMode::TryDeref);
        SG(726);
