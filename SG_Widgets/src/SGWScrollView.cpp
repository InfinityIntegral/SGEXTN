...
SGWScrollView::SGWScrollView(SGWWidget *parent, float x1, float x0, float y1, float y0, float w1, float w0, float h1, float h0, float i1, float i0, float s1, float s0) : SGWBackground(parent, x1, x0, y1, y0, w1, w0, h1, h0){
    (*this).i1 = i1;
    (*this).i0 = i0;
    (*this).s1 = s1;
    (*this).s0 = s0;
