...
public:
    ...
    QColor fillColour; // colour used to shade widget
    void setColour(); // set colour to default colour (transparent)
    void setColour(int themeColourIndex); // set colour to a theme colour
    void setColour(SGXColourRGBA customColour); // set colour to a custom colour
