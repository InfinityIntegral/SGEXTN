...
macro(BuildLah_find_dependencies)
    ...
    if(${PROJECT_NAME} STREQUAL "SGEXTN")
        ...
        message(STATUS "SGEXTN::SG_Core is required to use BuildLah, so if this fails, you corrupted your PATH somehow while BuildLah is running, such precise timing is honestly an achievement")
...
macro(BuildLah_add_component arg_target_name arg_target_type arg_files_path arg_build_define arg_use_define arg_qrc_prefix)
    ...
    if("SGEXTN::SG_Widgets" IN_LIST ARGN)
        set(link_SGWidgets TRUE)
    elseif("SG_Widgets" IN_LIST ARGN)
        set(link_SGWidgets TRUE)
    ...
    if(link_SGWidgets)
        ...
        qt6_add_qml_module(${arg_target_name} URI ${arg_target_name}_fakeqml OUTPUT_DIRECTORY ${arg_target_name}_fakeqml IMPORTS QtQuick QtQuick.Controls QtQuick.Dialogs QtQuick.Window)
