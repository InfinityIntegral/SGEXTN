...
public:
    ...
    [[nodiscard]] static String stringFromFloat(float x, SGEXTN::ApplicationBase::FloatDisplayFormat format, int precision);
    [[nodiscard]] static String stringFromDouble(double x, SGEXTN::ApplicationBase::FloatDisplayFormat format, int precision);
    [[nodiscard]] static String repeatChar(SGEXTN::ApplicationBase::Char c, int count);
