...
void SGEXTN::ApplicationBase::UnitTests::testString(){
    ...
    if(SGEXTN::ApplicationBase::String::stringFromInt(-26, 10) != "-26"){SGEXTN::Containers::Crash::crash("SGEXTN::ApplicationBase::String - string from positive int fail");}
    if(SGEXTN::ApplicationBase::String::stringFromInt(-26, 16) != "-1a"){SGEXTN::Containers::Crash::crash("SGEXTN::ApplicationBase::String - string from base 16 positive int fail");}
    if(SGEXTN::ApplicationBase::String::stringFromFloat(26.060f, SGEXTN::ApplicationBase::FloatDisplayFormat::Default, 5) != "26.06"){SGEXTN::Containers::Crash::crash("SGEXTN::ApplicationBase::String - string from float default formatting fail");}
    if(SGEXTN::ApplicationBase::String::stringFromFloat(26.060f, SGEXTN::ApplicationBase::FloatDisplayFormat::DecimalPlace, 5) != "26.06000"){SGEXTN::Containers::Crash::crash("SGEXTN::ApplicationBase::String - string from float decimal place formatting fail");}
    if(SGEXTN::ApplicationBase::String::stringFromFloat(26.060f, SGEXTN::ApplicationBase::FloatDisplayFormat::DecimalPlace, -1) != "30"){SGEXTN::Containers::Crash::crash("SGEXTN::ApplicationBase::String - string from float decimal place formatting with rounding fail");}
    if(SGEXTN::ApplicationBase::String::stringFromFloat(26.060f, SGEXTN::ApplicationBase::FloatDisplayFormat::ScientificNotation, 5) != "2.6060e+01"){SGEXTN::Containers::Crash::crash("SGEXTN::ApplicationBase::String - string from float scientific notation formatting fail");}
