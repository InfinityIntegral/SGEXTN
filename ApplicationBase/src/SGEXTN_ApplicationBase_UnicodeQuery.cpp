...
SGEXTN::ApplicationBase::GraphemeRuleRelatedType SGEXTN::ApplicationBase::UnicodeQuery::getGraphemeRuleRelatedType(int c){
    if(isUnicodeEmoji(c) == true){return SGEXTN::ApplicationBase::GraphemeRuleRelatedType::Rule11Emoji;}
    if(isUnicodeIndicGraphemeConsonant(c) == true){return SGEXTN::ApplicationBase::GraphemeRuleRelatedType::Rule9cConsonant;}
    if(isUnicodeIndicGraphemeLinker(c) == true){return SGEXTN::ApplicationBase::GraphemeRuleRelatedType::Rule9cLinker;}
    if(isUnicodeIndicGraphemeExtend(c) == true){return SGEXTN::ApplicationBase::GraphemeRuleRelatedType::Rule9cExtend;}
    return SGEXTN::ApplicationBase::GraphemeRuleRelatedType::None;
}

SGEXTN::ApplicationBase::String SGEXTN::ApplicationBase::UnicodeQuery::getEquivDecomposition(int c){
...
int SGEXTN::ApplicationBase::UnicodeQuery::getCombiningMarkOrder(int c){
    return getUnicodeCombiningMarkOrder(c);
}

int SGEXTN::ApplicationBase::UnicodeQuery::getBinaryRecomposition(int first, int second){
