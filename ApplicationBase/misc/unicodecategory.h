...
QString sgextnCategoryToOfficialCategory(SGEXTN::ApplicationBase::FullCharacterType c){
    if(c == SGEXTN::ApplicationBase::FullCharacterType::NonspacingCombiningMark){return "Mn";}
    if(c == SGEXTN::ApplicationBase::FullCharacterType::SpacingCombiningMark){return "Mc";}
    if(c == SGEXTN::ApplicationBase::FullCharacterType::EnclosingMark){return "Me";}
    if(c == SGEXTN::ApplicationBase::FullCharacterType::DecimalDigit){return "Nd";}
...
QString officialCategoryToSGExtnCategory(const QString& c){
    if(c == "Mn"){return "NonspacingCombiningMark";}
    if(c == "Mc"){return "SpacingCombiningMark";}
    if(c == "Me"){return "EnclosingMark";}
    if(c == "Nd"){return "DecimalDigit";}
