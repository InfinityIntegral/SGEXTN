...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator& SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator::operator++(){
...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator& SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator::operator++(){
    if((*associatedSet).memoryLengthInternal == 0){
        slot = -1;
        return (*this);
    }
...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator::operator++(int){
    Iterator prev = (*this);
    if((*associatedSet).memoryLengthInternal == 0){
        slot = -1;
        return (*this);
...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator::operator++(int){
...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::begin(){
    return (++end());
}

template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::end(){
    return Iterator(-1, 0, this);
}

template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::constBegin() const {
    return (++constEnd());
}

template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::constEnd() const {
...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::Iterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::find(const T& x){
...
template <typename T, typename EqualityCheck, typename HashFunction> SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::ConstIterator SGLUnorderedMultiSet<T, EqualityCheck, HashFunction>::find(const T& x) const {
