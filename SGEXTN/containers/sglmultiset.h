...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::leftRotate(Node* x){
    Node* y = (*x).rightChild;
    Node* z = (*y).leftChild;
    Node* p = (*x).parent;
    (*y).leftChild = x;
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::rightRotate(Node* x){
    Node* y = (*x).leftChild;
    Node* z = (*x).rightChild;
    Node* p = (*x).parent;
    (*y).rightChild = x;
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::rebalanceAtNode(Node* x){
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::getLeftMostSubchild(Node* x) const {
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::getRightMostSubChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::getParentWithThisAsLeftChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::getParentWithThisAsRightChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
        if((*x).parent == nullptr){return nullptr;}
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Iterator& SGLMultiSet<T, Comparator>::Iterator::operator++(){
    if(node == nullptr){
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::ConstIterator& SGLMultiSet<T, Comparator>::ConstIterator::operator++(){
    if(node == nullptr){
        node = (*associatedSet).getLeftMostSubchild((*associatedSet).root);
        copy = 0;
    }
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Iterator SGLMultiSet<T, Comparator>::Iterator::operator++(int){
    Iterator prev = (*this);
    if(node == nullptr){
        node = (*associatedSet).getLeftMostSubchild((*associatedSet).root);
        copy = 0;
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::ConstIterator SGLMultiSet<T, Comparator>::ConstIterator::operator++(int){
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::ConstIterator SGLMultiSet<T, Comparator>::constBegin() const {
    return ConstIterator(getLeftMostSubchild(root), 0, this);
}

template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Iterator SGLMultiSet<T, Comparator>::end(){
    return Iterator(nullptr, 0, this);
}

template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::ConstIterator SGLMultiSet<T, Comparator>::constEnd() const {
...
template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Iterator SGLMultiSet<T, Comparator>::iteratorAt(int n){
    int copy = 0;
    Node* node = getNodeByIndex(n, copy);
    return Iterator(node, copy, this);
}

template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::ConstIterator SGLMultiSet<T, Comparator>::constIteratorAt(int n) const {
    int copy = 0;
    Node* node = getNodeByIndex(n, copy);
    return ConstIterator(node, copy, this);
}

template <typename T, typename Comparator> SGLMultiSet<T, Comparator>::Node* SGLMultiSet<T, Comparator>::getNodeByIndex(int x, int& copy) const {
    if(root == nullptr){return nullptr;}
