#include "sgxrendercolourbackgroundquickuielement.h"
...
SGXRenderColourBackgroundQuickUIElement::SGXRenderColourBackgroundQuickUIElement(){
    (*this).setFlag(QQuickItem::ItemHasContents, true);
}

QSGNode* SGXRenderColourBackgroundQuickUIElement::updatePaintNode(QSGNode *thisNode, UpdatePaintNodeData */*unused*/){
    ...
    if(n == nullptr){
        ...
        SGXRenderColourBackgroundMaterial* m = new SGXRenderColourBackgroundMaterial();
        (*n).setMaterial(m);
    ...
    SGXRenderColourBackgroundMaterial* mat = static_cast<SGXRenderColourBackgroundMaterial*>((*n).material()); // NOLINT(cppcoreguidelines-pro-type-static-cast-downcast)
