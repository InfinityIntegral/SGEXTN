...
SGWIconButton::SGWIconButton(SGWWidget *parent, SGXChar s, void (*attachedFunction)(), float x1, float x0, float y1, float y0, float w1, float w0) : SGWButton(parent, s, attachedFunction, x1, x0, y1, y0, w1, w0, w1, w0, w1, w0, SGWDefaultFonts::iconsFont){
    (*this).textChar = s;
