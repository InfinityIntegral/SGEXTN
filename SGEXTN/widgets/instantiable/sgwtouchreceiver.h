...
{
public:
    SGWTouchReceiver(SGWWidget* parent, void (*function)(SGWTouchReceiver*, const SGLArray<SGXTouchEvent>&), float x1, float x0, float y1, float y0, float w1, float w0, float h1, float h0);
    ...
    void (*function)(SGWTouchReceiver*, const SGLArray<SGXTouchEvent>&);
