...
SGWLongLabel::SGWLongLabel(SGWWidget *parent, const QString &s, float x1, float x0, float y1, float y0, float w1, float w0, float h1, float h0, float f1, float f0, float s1, float s0) : SGWLabel(parent, s, x1, x0, y1, y0, w1, w0, h1, h0, f1, f0, SGWLabel::AlignLeft, SGWLabel::AlignTop, SGWLabel::textFont){
    (*this).s1 = s1;
    (*this).s0 = s0;
