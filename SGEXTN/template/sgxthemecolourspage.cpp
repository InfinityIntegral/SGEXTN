...
QQuickItem* SGXThemeColoursPage::initialise(){
    ...
    QString s = "";
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.0f / 11.1f, 0.5f - 0.0f / 11.f * 1.5f, 0.0f, 4.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(0, 0, 0).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.2f / 11.1f, 0.5f - 0.2f / 11.f * 1.5f, 0.0f, 4.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(64, 0, 50).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.4f / 11.1f, 0.5f - 0.4f / 11.f * 1.5f, 0.0f, 4.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(128, 0, 100).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 1.2f / 11.1f, 0.5f - 1.2f / 11.f * 1.5f, 0.0f, 4.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(191, 0, 150).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 2.0f / 11.1f, 0.5f - 2.0f / 11.f * 1.5f, 0.0f, 4.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 0, 200).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 4.5f / 11.1f, 0.5f - 4.5f / 11.f * 1.5f, 0.0f, 4.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 64, 214).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 5.3f / 11.1f, 0.5f - 5.3f / 11.f * 1.5f, 0.0f, 4.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 128, 227).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 7.8f / 11.1f, 0.5f - 7.8f / 11.f * 1.5f, 0.0f, 4.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 191, 241).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 8.6f / 11.1f, 0.5f - 8.6f / 11.f * 1.5f, 0.0f, 4.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    ...
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.0f / 11.1f, 0.5f - 0.0f / 11.f * 1.5f, 0.0f, 18.5f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 255, 255).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.2f / 11.1f, 0.5f - 0.2f / 11.f * 1.5f, 0.0f, 18.5f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 191, 241).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.4f / 11.1f, 0.5f - 0.4f / 11.f * 1.5f, 0.0f, 18.5f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 128, 227).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 1.2f / 11.1f, 0.5f - 1.2f / 11.f * 1.5f, 0.0f, 18.5f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 64, 214).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 2.0f / 11.1f, 0.5f - 2.0f / 11.f * 1.5f, 0.0f, 18.5f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 0, 200).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 4.5f / 11.1f, 0.5f - 4.5f / 11.f * 1.5f, 0.0f, 18.5f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(191, 0, 150).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 5.3f / 11.1f, 0.5f - 5.3f / 11.f * 1.5f, 0.0f, 18.5f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(128, 0, 100).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 7.8f / 11.1f, 0.5f - 7.8f / 11.f * 1.5f, 0.0f, 18.5f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(64, 0, 50).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 8.6f / 11.1f, 0.5f - 8.6f / 11.f * 1.5f, 0.0f, 18.5f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(0, 0, 0).getQColour());
    ...
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.0f / 11.1f, 0.5f - 0.0f / 11.f * 1.5f, 0.0f, 33.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(0, 0, 0).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.2f / 11.1f, 0.5f - 0.2f / 11.f * 1.5f, 0.0f, 33.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(60, 9, 14).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.4f / 11.1f, 0.5f - 0.4f / 11.f * 1.5f, 0.0f, 33.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(119, 19, 27).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 1.2f / 11.1f, 0.5f - 1.2f / 11.f * 1.5f, 0.0f, 33.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(179, 28, 41).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 2.0f / 11.1f, 0.5f - 2.0f / 11.f * 1.5f, 0.0f, 33.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(238, 37, 54).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 4.5f / 11.1f, 0.5f - 4.5f / 11.f * 1.5f, 0.0f, 33.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(242, 92, 104).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 5.3f / 11.1f, 0.5f - 5.3f / 11.f * 1.5f, 0.0f, 33.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(247, 146, 155).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 7.8f / 11.1f, 0.5f - 7.8f / 11.f * 1.5f, 0.0f, 33.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(251, 201, 205).getQColour());
    obj = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 8.6f / 11.1f, 0.5f - 8.6f / 11.f * 1.5f, 0.0f, 33.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    (*obj).setProperty("color", SGXColourRGBA(255, 255, 255).getQColour());
    ...
    SGXThemeColoursPage::customLightColoursDisplay[0] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.0f / 11.1f, 0.5f - 0.0f / 11.f * 1.5f, 0.0f, 49.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[1] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.2f / 11.1f, 0.5f - 0.2f / 11.f * 1.5f, 0.0f, 49.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[2] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.4f / 11.1f, 0.5f - 0.4f / 11.f * 1.5f, 0.0f, 49.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[3] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 1.2f / 11.1f, 0.5f - 1.2f / 11.f * 1.5f, 0.0f, 49.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[4] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 2.0f / 11.1f, 0.5f - 2.0f / 11.f * 1.5f, 0.0f, 49.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[5] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 4.5f / 11.1f, 0.5f - 4.5f / 11.f * 1.5f, 0.0f, 49.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[6] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 5.3f / 11.1f, 0.5f - 5.3f / 11.f * 1.5f, 0.0f, 49.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[7] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 7.8f / 11.1f, 0.5f - 7.8f / 11.f * 1.5f, 0.0f, 49.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customLightColoursDisplay[8] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 8.6f / 11.1f, 0.5f - 8.6f / 11.f * 1.5f, 0.0f, 49.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    ...
    SGXThemeColoursPage::customDarkColoursDisplay[0] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.0f / 11.1f, 0.5f - 0.0f / 11.f * 1.5f, 0.0f, 65.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[1] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.2f / 11.1f, 0.5f - 0.2f / 11.f * 1.5f, 0.0f, 65.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[2] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.4f / 11.1f, 0.5f - 0.4f / 11.f * 1.5f, 0.0f, 65.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[3] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 1.2f / 11.1f, 0.5f - 1.2f / 11.f * 1.5f, 0.0f, 65.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[4] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 2.0f / 11.1f, 0.5f - 2.0f / 11.f * 1.5f, 0.0f, 65.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[5] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 4.5f / 11.1f, 0.5f - 4.5f / 11.f * 1.5f, 0.0f, 65.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[6] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 5.3f / 11.1f, 0.5f - 5.3f / 11.f * 1.5f, 0.0f, 65.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[7] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 7.8f / 11.1f, 0.5f - 7.8f / 11.f * 1.5f, 0.0f, 65.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customDarkColoursDisplay[8] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 8.6f / 11.1f, 0.5f - 8.6f / 11.f * 1.5f, 0.0f, 65.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    ...
    SGXThemeColoursPage::customAnyColoursDisplay[0] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.0f / 11.1f, 0.5f - 0.0f / 11.f * 1.5f, 0.0f, 93.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[1] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.2f / 11.1f, 0.5f - 0.2f / 11.f * 1.5f, 0.0f, 93.0f, 0.2f / 11.1f, -1.5f * 0.2f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[2] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 0.4f / 11.1f, 0.5f - 0.4f / 11.f * 1.5f, 0.0f, 93.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[3] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 1.2f / 11.1f, 0.5f - 1.2f / 11.f * 1.5f, 0.0f, 93.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[4] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 2.0f / 11.1f, 0.5f - 2.0f / 11.f * 1.5f, 0.0f, 93.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[5] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 4.5f / 11.1f, 0.5f - 4.5f / 11.f * 1.5f, 0.0f, 93.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[6] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 5.3f / 11.1f, 0.5f - 5.3f / 11.f * 1.5f, 0.0f, 93.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[7] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 7.8f / 11.1f, 0.5f - 7.8f / 11.f * 1.5f, 0.0f, 93.0f, 0.8f / 11.1f, -1.5f * 0.8f / 11.1f, 0.0f, 2.0f, -1, true);
    SGXThemeColoursPage::customAnyColoursDisplay[8] = SGXQuickUIInterface::createWidget(SGXThemeColoursPage::instance, 8.6f / 11.1f, 0.5f - 8.6f / 11.f * 1.5f, 0.0f, 93.0f, 2.5f / 11.1f, -1.5f * 2.5f / 11.1f, 0.0f, 2.0f, -1, true);
