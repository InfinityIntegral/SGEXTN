...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::leftRotate(Node* x){
    Node* y = (*x).rightChild;
    Node* z = (*y).leftChild;
    Node* p = (*x).parent;
    (*y).leftChild = x;
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::rightRotate(Node* x){
    Node* y = (*x).leftChild;
    Node* z = (*y).rightChild;
    Node* p = (*x).parent;
    (*y).rightChild = x;
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::rebalanceAtNode(Node* x){
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::getLeftmostSubchild(Node* x) const {
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::getRightmostSubchild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::getParentWithThisAsLeftChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::getParentWithThisAsRightChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
        if((*x).parent == nullptr){return nullptr;}
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator& SGLMap<K, V, Comparator>::Iterator::operator++(){
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator& SGLMap<K, V, Comparator>::ConstIterator::operator++(){
    if(node == nullptr){node = (*associatedSet).getLeftmostSubchild((*associatedSet).root);}
    else if((*node).rightChild == nullptr){node = (*associatedSet).getParentWithThisAsLeftChild(node);}
    else{node = (*associatedSet).getLeftmostSubchild((*node).rightChild);}
    return (*this);
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::Iterator::operator++(int){
    Iterator prev = (*this);
    if(node == nullptr){node = (*associatedSet).getLeftmostSubchild((*associatedSet).root);}
    else if((*node).rightChild == nullptr){node = (*associatedSet).getParentWithThisAsLeftChild(node);}
    else{node = (*associatedSet).getLeftmostSubchild((*node).rightChild);}
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::ConstIterator::operator++(int){
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::begin(){
    return Iterator(getLeftmostSubchild(root), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::constBegin() const {
    return ConstIterator(getLeftmostSubchild(root), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::end(){
    return Iterator(nullptr, this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::constEnd() const {
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::find(const K& x){
    return Iterator(findNode(x), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::find(const K& x) const {
    return ConstIterator(findNode(x), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::lowerBoundNode(const K& x) const {
    Node* output = nullptr;
    Node* currentNode = root;
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::upperBoundNode(const K& x) const {
    Node* output = nullptr;
    Node* currentNode = root;
    while(currentNode != nullptr){
        if(comparatorInstance(x, (*currentNode).key) == true){
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::lowerBound(const K& x){
    return Iterator(lowerBoundNode(x), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::lowerBound(const K& x) const {
    return ConstIterator(lowerBoundNode(x), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::upperBound(const K& x){
    return Iterator(upperBoundNode(x), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::upperBound(const K& x) const {
...
template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Iterator SGLMap<K, V, Comparator>::iteratorAt(int n){
    return Iterator(getNodeByIndex(n), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::ConstIterator SGLMap<K, V, Comparator>::constIteratorAt(int n) const {
    return ConstIterator(getNodeByIndex(n), this);
}

template <typename K, typename V, typename Comparator> typename SGLMap<K, V, Comparator>::Node* SGLMap<K, V, Comparator>::getNodeByIndex(int x) const {
    if(root == nullptr){return nullptr;}
