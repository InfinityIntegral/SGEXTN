...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::leftRotate(Node* x){
    Node* y = (*x).rightChild;
    Node* z = (*y).leftChild;
    Node* p = (*x).parent;
    (*y).leftChild = x;
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::rightRotate(Node* x){
    Node* y = (*x).leftChild;
    Node* z = (*y).rightChild;
    Node* p = (*x).parent;
    (*y).rightChild = x;
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::rebalanceAtNode(Node* x){
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::getLeftmostSubchild(Node* x) const {
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::getRightmostSubchild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::getParentWithThisAsLeftChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::getParentWithThisAsRightChild(Node* x) const {
    if(x == nullptr){return nullptr;}
    while(true){
        if((*x).parent == nullptr){return nullptr;}
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator& SGLSet<T, Comparator>::Iterator::operator++(){
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator& SGLSet<T, Comparator>::ConstIterator::operator++(){
    if(node == nullptr){node = (*associatedSet).getLeftmostSubchild((*associatedSet).root);}
    else if((*node).rightChild == nullptr){node = (*associatedSet).getParentWithThisAsLeftChild(node);}
    else{node = (*associatedSet).getLeftmostSubchild((*node).rightChild);}
    return (*this);
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::Iterator::operator++(int){
    Iterator prev = (*this);
    if(node == nullptr){node = (*associatedSet).getLeftmostSubchild((*associatedSet).root);}
    else if((*node).rightChild == nullptr){node = (*associatedSet).getParentWithThisAsLeftChild(node);}
    else{node = (*associatedSet).getLeftmostSubchild((*node).rightChild);}
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::ConstIterator::operator++(int){
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::begin(){
    return Iterator(getLeftmostSubchild(root), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::constBegin() const {
    return ConstIterator(getLeftmostSubchild(root), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::end(){
    return Iterator(nullptr, this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::constEnd() const {
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::find(const T& x){
    return Iterator(findNode(x), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::find(const T& x) const {
    return ConstIterator(findNode(x), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::lowerBoundNode(const T& x) const {
    Node* output = nullptr;
    Node* currentNode = root;
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::upperBoundNode(const T& x) const {
    Node* output = nullptr;
    Node* currentNode = root;
    while(currentNode != nullptr){
        if(comparatorInstance(x, (*currentNode).value) == true){
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::lowerBound(const T& x){
    return Iterator(lowerBoundNode(x), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::lowerBound(const T& x) const {
    return ConstIterator(lowerBoundNode(x), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::upperBound(const T& x){
    return Iterator(upperBoundNode(x), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::upperBound(const T& x) const {
...
template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Iterator SGLSet<T, Comparator>::iteratorAt(int n){
    return Iterator(getNodeByIndex(n), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::ConstIterator SGLSet<T, Comparator>::constIteratorAt(int n) const {
    return ConstIterator(getNodeByIndex(n), this);
}

template <typename T, typename Comparator> typename SGLSet<T, Comparator>::Node* SGLSet<T, Comparator>::getNodeByIndex(int x) const {
    if(root == nullptr){return nullptr;}
