...
void SGLCrash::crashOnInsert(){
    throw std::runtime_error("You attempted to insert a element or key into a SGLSet / SGLUnorderedSet / SGLMap / SGLUnorderedMap when the element or key already exists in the data structure.");
}
