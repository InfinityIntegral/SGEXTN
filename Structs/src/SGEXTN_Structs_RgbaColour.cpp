...
SGEXTN::ApplicationBase::String SGEXTN::Structs::RgbaColour::rgbHexString() const {
    return (SGEXTN::ApplicationBase::String::stringFromInt(getRed(), 16).fillLeftToLength(2, '0') + SGEXTN::ApplicationBase::String::stringFromInt(getGreen(), 16).fillLeftToLength(2, '0') + SGEXTN::ApplicationBase::String::stringFromInt(getBlue(), 16).fillLeftToLength(2, '0'));
}

SGEXTN::ApplicationBase::String SGEXTN::Structs::RgbaColour::rgbaHexString() const {
    return (SGEXTN::ApplicationBase::String::stringFromInt(getRed(), 16).fillLeftToLength(2, '0') + SGEXTN::ApplicationBase::String::stringFromInt(getGreen(), 16).fillLeftToLength(2, '0') + SGEXTN::ApplicationBase::String::stringFromInt(getBlue(), 16).fillLeftToLength(2, '0') + SGEXTN::ApplicationBase::String::stringFromInt(getTransparency(), 16).fillLeftToLength(2, '0'));
}

SGEXTN::ApplicationBase::String SGEXTN::Structs::RgbaColour::rgbFloatHtmlString() const {
    return (SGEXTN::ApplicationBase::String("rgb(") + SGEXTN::ApplicationBase::String::stringFromFloat(getRedFloat(), SGEXTN::ApplicationBase::FloatDisplayFormat::DecimalPlace, 3) + ", " + SGEXTN::ApplicationBase::String::stringFromFloat(getGreenFloat(), SGEXTN::ApplicationBase::FloatDisplayFormat::DecimalPlace, 3) + ", " + SGEXTN::ApplicationBase::String::stringFromFloat(getBlueFloat(), SGEXTN::ApplicationBase::FloatDisplayFormat::DecimalPlace, 3) + ")");
}
...
float SGEXTN::Structs::RgbaColour::wcag2ContrastRatio(SGEXTN::Structs::RgbaColour bg, SGEXTN::Structs::RgbaColour fg){
...
float SGEXTN::Structs::RgbaColour::wcag3ContrastRatio(SGEXTN::Structs::RgbaColour bg, SGEXTN::Structs::RgbaColour fg){
    fg = bg.applyTint(fg, true);
